...
technologies:
  [
    { language: 'Golang', link: 'https://go.dev/' },
    {
      language: 'Terraform',
    ...
    { language: 'Lambda', link: 'https://aws.amazon.com/lambda/' },
    { language: 'S3', link: 'https://aws.amazon.com/s3/' },
    { language: 'SQS', link: 'https://aws.amazon.com/sqs/' },
    { language: 'SNS', link: 'https://aws.amazon.com/sns/' },
    { language: 'SES', link: 'https://aws.amazon.com/ses/' },
  ]
---
